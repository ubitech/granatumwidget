...
extends HttpServlet
{
    private String consumerKey = "UBITECH - Search";
    private String consumerSecret = "a8800285d92821bd0c391d4d7f0c351c";
        ...
        try
        {
            ...
            else if(operation.equals("reqAccessOAuth"))
            {
                ...
                if(oauthClient.getOauthTokenAccess()!=null)
                    this.forwardToPage("/jsfs/search.jsf", request, response);
            }
        } 
        catch(Throwable t)
        {            
