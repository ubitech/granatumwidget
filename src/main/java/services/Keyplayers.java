...
extends HttpServlet
{
    private String consumerKey = "UBITECH - Keyplayers";
    private String consumerSecret = "ba45625de5f7e1c792a92db8faa617e3";
        ...
        try
        {
            ...
            else if(operation.equals("reqAccessOAuth"))
            {
                ...
                if(oauthClient.getOauthTokenAccess()!=null)
                    this.forwardToPage("/jsfs/keyplayers.jsf?" + request.getParameter("userID"), request, response);
            }
        } 
        catch(Throwable t)
        {            
